    ...
    <div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
        <form method="POST" action="{{ route('login') }}" class="login100-form validate-form">
            ...
            <div class="wrap-input100 validate-input m-b-20" data-validate="Enter username or email">
                <input class="input100"  id="email" type="email" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="username or email">
            ...
            {{--                <a href="#" class="login100-social-item">--}}
            {{--                    <img src="{{asset('templateLogin/images/icons/icon-google.png')}}" alt="GOOGLE">--}}
            {{--                </a>--}}
            {{--            </div>--}}

            <div class="text-center">
                <a href="{{route('user.index')}}" class="txt2 hov1">
                    Sign Up
                </a>
            </div>
        </form>
