...
@section('content')
    <h1>Yakin ingin menghapus fasilitas ini ?</h1>
...
{{--        </form>--}}
{{--    </div>--}}
    <form action="{{route('dashboard.fasilitas.destroy', $fasilitas -> id)}}" method="post" class="was-validated" enctype="multipart/form-data" style="margin-top: 1%;">
        {{csrf_field()}}
        {{ method_field('DELETE') }}
        <div class="container">
            <div class="row">
