...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
        <a class="navbar-brand" href="{{route('index.landing')}}" style="color: black;">MY INN</a>
            ...
            @if (Route::has('login'))
                @auth
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item active"><a href="{{route('index.landing')}}" class="nav-link" style="color: black;">Home</a></li>
                        @if (Route::has('login'))
                            @if ($user->role_name == 'User Homestay')
                                <li class="nav-item active"><a href="{{route('tambah.homestay.index')}}" class="nav-link" style="color: black;">Tambah Homestay</a></li>
                            @endif
                        @endif
                ...
                @else
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item active"><a href="{{route('index.landing')}}" class="nav-link" style="color: black;">Home</a></li>
                        <li class="nav-item"><a href="/user-register" class="nav-link" style="color: black;">Daftar</a></li>
                        <li class="nav-item"><a href="/user-login" class="nav-link" style="color: black;">Masuk</a></li>
                    </ul>
                @endauth
            @endif
